...
round(aa6$stats[3,],0)
aa7 <-  boxplot(adjusted ~ unlist(gtsFilled["10_13167814", ]))
round(aa7$stats[3,],0)
aa8 <-  boxplot(adjusted ~ unlist(gtsFilled["12_34390148", ]))
round(aa8$stats[3,],0)
aa9 <-  boxplot(adjusted ~ unlist(gtsFilled["14_73006995", ]))
round(aa9$stats[3,],0)
aa10 <-  boxplot(adjusted ~ unlist(gtsFilled["17_17733625", ]))
...
aa15 <-  boxplot(adjusted ~ unlist(gtsFilled["3_159581164", ]))
